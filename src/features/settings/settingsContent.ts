    ...
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          id: 'spellCheckerInfo',
          implementation: 'derived',
          labelKey: 'settings.advanced.systemSpellchecker',
          valueKey: 'settings.value.ready',
          testId: 'settings-advanced-system-spellchecker',
        },
        {
          kind: 'toggle',
        ...
        },
        {
          ...
          id: 'spellcheckProbe',
          implementation: 'derived',
          labelKey: 'settings.advanced.spellcheckProbe',
          valueKey: 'settings.value.open',
          testId: 'settings-advanced-spellcheck-probe',
        },
      ],
    },
    {
