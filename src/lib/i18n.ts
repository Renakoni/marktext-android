...
const MESSAGES = {
  [APP_LOCALES.EN]: {
    ...
    'settings.selectionToolbar.custom.reorderHint':
      'Tap a selected command to remove it; long-press the preview to reorder.',
  ...
  [APP_LOCALES.ZH_CN]: {
    ...
    'editor.selection.pageStatus': '命令第 {current}/{total} 页',
    ...
    'settings.selectionToolbar.custom.reorderHint': '再次点按已选命令可移除；长按预览可拖动排序。',
